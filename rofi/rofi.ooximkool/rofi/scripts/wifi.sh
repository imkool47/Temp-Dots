...
while true; do
	...
	# Show ROFI menu
    chosen=$(printf "%b" "$menu_list" | rofi -theme ~/.config/rofi/waybar-input-menu.rasi -theme-str 'window {location: north east; x-offset: -255; y-offset: 144; width: 255px; height: 200px;} listview {columns: 1;} inputbar {enabled: false;} mode-switcher { enabled: false; }' -dmenu -i)
